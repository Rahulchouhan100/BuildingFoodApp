...
const Instamart = () => {
  const [config, setConfig] = useState("edit");
  return (
    <>
      ...
      <Section
        ...
        isVisible={config === "edit"}
        setIsVisible={() => setConfig("edit")}
      />
      <Section
        ...
        setIsVisible={() => setConfig("cancelOrder")}
      />
      <Section
        ...
        isVisible={config === "minOrder"}
        setIsVisible={() => setConfig("minOrder")}
      />
      <Section
        title={"I want an invoice for my order"}
        description={"send an email. We will revert within 24-48 hrs"}
        isVisible={config === "invoice"}
        setIsVisible={() => setConfig("invoice")}
      />
    </>
  );
};
